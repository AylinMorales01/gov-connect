INSERT INTO departments (code, name, description) VALUES
      ('HAC', 'Hacienda', 'Secretaría encargada de finanzas y recaudo'),
      ('SAL', 'Salud', 'Secretaría de Salud y Seguridad Social'),
      ('EDU', 'Educación', 'Secretaría de Educación Municipal'),
      ('PLA', 'Planeación', 'Secretaría de Planeación y Ordenamiento'),
